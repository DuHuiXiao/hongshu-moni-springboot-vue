...
import com.app.platform.client.EsClient;
import com.app.platform.client.OssClient;
import com.app.platform.service.*;
import com.app.xo.entity.*;
...
import com.app.xo.dao.NoteDao;
import com.app.xo.dto.NoteDTO;
...
public class NoteServiceImpl extends ServiceImpl<NoteDao, Note> implements NoteService {
    ...
    public NoteVo getNoteById(String noteId) {
        ...
        if (note == null) {
            throw new AppException(ResultCodeEnum.FAIL);
        }
    ...
    public boolean pinnedNote(String noteId) {
        ...
        if (note.getPinned().equals(1)) {
            ...
            if (count >= 2) {
                throw new AppException("最多只能置顶2个笔记");
            }
            note.setPinned(1);
        }
